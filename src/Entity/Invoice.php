...
#[ApiResource(attributes: ["pagination_enabled" => true,
            ...
            itemOperations:["GET","PUT","DELETE","increment"=>[
                ...
                "swagger_context"=>["summary"=>"Icrémente une facture",
...
class Invoice
{
    ...
    #[Assert\Choice(choices:["PAID","SENT","CANCELLED"], message:"Le Status doit être SENT , PAID ou CANCELLED")]
    private $status;
    ...
    #[Assert\Type(type:"integer", message:"Le montant du chrono doit être un nombre !")]
    private $chrono;
